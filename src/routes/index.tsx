          ...
          <div className="max-w-6xl mx-auto px-4 sm:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <div className="space-y-4 text-sm text-[#6f6a63]">
                ...
                <p className="flex items-center gap-3">
                  <span className="text-lg">✉</span>{" "}
                  <a href="mailto:comercial@riscotex.com.br" className="underline hover:text-[#2e2f33]">
                    comercial@riscotex.com.br
                  </a>
                </p>
                <p className="flex items-center gap-3">
                  <span className="text-lg">📞</span> (41) 99619-8555
                </p>
                <p className="flex items-center gap-3">
                  <span className="text-lg">📞</span> (47) 99238-4773
                </p>
              </div>
            </div>
